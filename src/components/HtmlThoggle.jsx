    ...
    <div>
      <div className="navbar">
        ...
        <div className="toggle-div" onClick={() => {
          ...
          <img src={darkMode ? assets.icon_sun_light : assets.icon_sun_dark} alt="" />
          <div className="toggle-bar-div">
            <div className="toggle-thumb toggle-thumb-dark"></div>
          </div>
          <img src={darkMode ? assets.icon_moon_light : assets.icon_moon_dark} alt="" />
        </div>
      </div>
    </div>
  );
